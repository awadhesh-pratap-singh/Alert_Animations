...
class ViewController2: UIViewController {
    ...
    @IBAction func showSuccess(_ sender: AnyObject) {
        ...
        _ = alert.addButton("First Button", target:self, selector:#selector(ViewController2.firstButton))
...
//        SCLAlertView().showError(self, title: kErrorTitle, subTitle: kSubtitle)
    ...
    @IBAction func showWarning(_ sender: AnyObject) {
        ...
        _ = alert.addButton("Invoice",backgroundColor: UIColor.systemYellow, target:self, selector:#selector(ViewController2.firstButton))
        _ = alert.addButton("Consignment Order",backgroundColor: UIColor.systemYellow) {
            print("Second button tapped")
        }

        _ = alert.showWarning(Alert, subTitle: "")
    }
...
//        let alert = SCLAlertView(appearance: appearance)
//        _ = alert.addButton("Print",backgroundColor: UIColor.green, target:self, selector:#selector(ViewController2.firstButton))
//        _ = alert.addButton("Cancel",backgroundColor: UIColor.red) {
//            print("Second button tapped")
//
//        }
//
//        let icon = UIImage(named:"ok.png")
//        let color = UIColor.orange
//
//        _ = alert.showCustom("Invoice generated successfully. \nInvoice No: INV10016", subTitle: "Do you want to Print Invoice?", color: color, icon: icon!, circleIconImage: icon!)
        let alert = SCLAlertView(appearance: appearance)
        _ = alert.addButton("Print",backgroundColor: UIColor.green) {
...
//                                                   horizontal: 30)
   ...
   //   margin: margin
    ...
    let alert = SCLAlertView(appearance: appearance)
    _ = alert.addButton("First", target:self, selector:#selector(ViewController2.firstButton))

    let icon = UIImage(named:"custom_icon.png")
    let color = UIColor.orange

      _ = alert.showCustom("Empty SubTitle Alert", subTitle: "This is an empty subTitle alertView with horizontal and bottom margin equals 30", color: color, icon: UIImage(named: "flag")!, circleIconImage: icon!)
